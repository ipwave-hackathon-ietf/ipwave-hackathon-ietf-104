...
//            auto srcMac = pkt->getTag<inet::MacAddressReq>()->getSrcAddress();
...
//    unique_ptr<cPacket> cPkt(check_and_cast<cPacket*>(macPkt->decapsulate()));
    ...
    if (dest == myMacAddress) {
        ...
        {
//            unique_ptr<inet::Packet> pkt(check_and_cast<inet::Packet*>(macPkt->decapsulate()));
